...
import com.nutrimate.nutrimatebackend.config.oauth.LoggingOAuth2LoginAuthenticationFilter;
...
public class SecurityConfig {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http,
		...
		LoggingOAuth2LoginAuthenticationFilter loggingFilter =
				new LoggingOAuth2LoginAuthenticationFilter(clientRegistrationRepository,
				                                           authorizedClientService);
		loggingFilter.setAuthenticationManager(authenticationManager);
		...
		http.csrf(t -> t.disable())
		    ...
		    .addFilter(new JwtAuthorizationFilter(authenticationManager,
		                                          memberMapper)) // AuthenticationManager
		    ...
		    .addFilterAfter(loggingFilter, LogoutFilter.class);
		;
