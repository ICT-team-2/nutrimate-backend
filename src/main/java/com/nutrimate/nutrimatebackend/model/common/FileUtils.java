package com.nutrimate.nutrimatebackend.model.common;
...
public class FileUtils {
	...
	// 업로드 로직
	public static StringBuffer upload(List<MultipartFile> files, String saveDirectory)
		...
		try {
			...
			for (MultipartFile file : files) {
				if (file.getContentType() != null) {// input type="file"인 경우
					...
					// 파일명을 스프링버퍼에 저장
					fileNames.append("/imageLoading/" + newFilename + ",");// 구분자 ,
				}
			}
