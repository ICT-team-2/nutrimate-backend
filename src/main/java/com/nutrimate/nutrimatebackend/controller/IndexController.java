package com.nutrimate.nutrimatebackend.controller;
...
public class IndexController {
  ...
  // 생성자 주입
  public IndexController(MemberService memberService, BCryptPasswordEncoder passwordEncorder) {
  ...
  public String insertMember(MemberDto memberDto) {
    memberDto.setUserPwd(passwordEncorder.encode(memberDto.getUserPwd()));
