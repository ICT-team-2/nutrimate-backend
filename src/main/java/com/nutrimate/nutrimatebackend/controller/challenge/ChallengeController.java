...
public class ChallengeController {
    ...
    @PostMapping("/account")
    public ResponseEntity<Map<String, Object>> createAccountChallenge(
            @RequestBody ChallengeChatDto dto) {
        Map<String, Object> challengeChatMemeber = new HashMap<>();
        // 챌린지 중복 확인
    ...
    // 챌린지 등수
    @GetMapping("/success")
    public List<ChallengeChatDto> challengeSuccessList(@RequestParam("chatroomId") int chatroomId) {
        return challengeService.getChallengeSuccessList(chatroomId);
    }
